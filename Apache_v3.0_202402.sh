...
echo "Input a apache main configuration file. (ex. /etc/apache2/apache2.conf)"
while true
do 
	echo -n "Input path : " 
	read HTTP_CONF_INP
...
# [WA-1] Apache 웹 프로세스 권한 제한
echo "[WA-1] Apache 웹 프로세스 권한 제한"
echo "=======================================================================" 	>> $RESULT_FILE 2>&1
echo "[WA-1] Apache 웹 프로세스 권한 제한"  >> $RESULT_FILE 2>&1
echo "=======================================================================" 	>> $RESULT_FILE 2>&1
echo >> $RESULT_FILE 2>&1
...
# [WA-2] Apache 디렉토리 리스팅 제거
echo "[WA-2] Apache 디렉토리 리스팅 제거"
echo "=======================================================================" 	>> $RESULT_FILE 2>&1
echo "[WA-2] Apache 디렉토리 리스팅 제거"  >> $RESULT_FILE 2>&1
echo "=======================================================================" 	>> $RESULT_FILE 2>&1
echo >> $RESULT_FILE 2>&1
